...
- `B` = DS intéressant mais plus senior / plus “business”
...
- Pourquoi c’est un fit:
  - Problèmes ops (ETA, optimisation logistique, monitoring) → plus proche “systèmes/contraintes” qu’un DS purement marketing.
  - Espace pour ton angle “validation/robustesse sur données imparfaites” + itération expé → prod.
- Risque/gap principal:
  - Rôle “Senior” (ils citent 5–10 ans): cadrer franchement ta séniorité sur ownership technique + rigueur de validation.
...
- Pourquoi c’est intéressant:
  - Secteur énergie + possibilité de mettre en avant rigueur de validation, expérimentation, “impact mesuré”.
  - Leur formulaire demande explicitement motivations/forces + prétentions salariales → c’est clair et actionnable.
- Risque/gap principal:
  - Poste “Lead” (management + sujets potentiellement “commercial/expérience client”) → risque d’éloignement de l’axe R&D/physical systems.
...
- Pourquoi c’est potentiellement intéressant:
  - Rôle “data science produit” avec A/B tests + causal inference + métriques: bon terrain pour ton axe “validation/robustesse”.
- Risque/gap principal:
...
- Pourquoi c’est potentiellement intéressant:
  - Problèmes “ops + confiance” (fraud detection/modération) + production ML: permet de valoriser rigueur validation + monitoring.
- Risque/gap principal:
...
- Veepee — Data Scientist / Senior Data Scientist: rôle recommandation/pricing e-commerce (moins industriel/R&D / physical-systems adjacent) → exclu.
  - Offre: https://jobs.lever.co/veepee/1490a34b-351a-4bfb-8b80-97419e9d2dcb

### Exclus — non-France-first (même si ouvert)

- Kraken — Data Scientist in Power Electrical Systems: offre trouvée mais localisée **Berlin** (pas France-first) → exclu.
  - Offre: https://jobs.lever.co/kraken123/f0259302-5cd0-48e9-bc69-c351c9fbe8da
